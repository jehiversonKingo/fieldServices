...
const OrdersDescriptionAddScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header isLeft={true} navigation={navigation} title={'Agregar Orden'} />
...
export default OrdersDescriptionAddScreen;