...
export const axiosInstance = axios.create({
  baseURL: 'https://dabf-2803-d100-ea40-690-e931-4657-8143-6853.ngrok-free.app/stack-ant-dev/us-central1/fieldservice',
...
export const axiosInstanceShopkeeper = axios.create({
  ...
  baseURL: "https://dabf-2803-d100-ea40-690-e931-4657-8143-6853.ngrok-free.app/stack-ant-dev/us-central1/shopkeeperapi",
