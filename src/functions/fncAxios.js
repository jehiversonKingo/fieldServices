...
export const axiosInstance = axios.create({
  baseURL: 'https://1c3c-200-35-181-90.ngrok-free.app/stack-ant-dev/us-central1/fieldservice',
  // baseURL: process.env.REACT_APP_URI_FIELD,
});

export const axiosInstanceShopkeeper = axios.create({
  baseURL: "https://1c3c-200-35-181-90.ngrok-free.app/stack-ant-dev/us-central1/shopkeeperapi",
