...
export const axiosInstance = axios.create({
  baseURL: 'https://0690-200-35-181-90.ngrok-free.app/stack-ant-dev/us-central1/fieldservice',
...
export const axiosInstanceShopkeeper = axios.create({
  ...
  baseURL: "https://0690-200-35-181-90.ngrok-free.app/stack-ant-dev/us-central1/shopkeeperapi",
