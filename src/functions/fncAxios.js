...
export const axiosInstance = axios.create({
  //baseURL: 'https://6336-45-173-219-85.ngrok-free.app/stack-ant-prod/us-central1/fieldservice',
  baseURL: process.env.REACT_APP_URI_FIELD, 
});

export const axiosInstanceShopkeeper = axios.create({
  //baseURL: "https://6336-45-173-219-85.ngrok-free.app/stack-ant-prod/us-central1/shopkeeperapi",
