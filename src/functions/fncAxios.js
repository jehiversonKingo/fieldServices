...
export const axiosInstance = axios.create({
  // baseURL: 'https://c682-200-35-181-90.ngrok-free.app/stack-ant-prod/us-central1/fieldservice',
  baseURL: process.env.REACT_APP_URI_FIELD,
});

export const axiosInstanceShopkeeper = axios.create({
  // baseURL: "https://c682-200-35-181-90.ngrok-free.app/stack-ant-prod/us-central1/shopkeeperapi",
